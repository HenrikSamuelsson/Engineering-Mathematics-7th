...
\setcounter{enumi}{22}
\item
The prime factorization of 84 and 512 are
...
\begin{enumerate}[label=\textbf{\arabic*.}]
\item
Repeated integer division by increasingly bigger numbers gives the following product of prime factors. 
...
\begin{enumerate}[label=\textbf{(\alph*)}]
\item
The prime factorization of 63 and 42 are
